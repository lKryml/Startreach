...
class UserModel(BaseModel):
    ...
    user_type: Annotated[int | None, Field(min=1, max=10)] = None # if not set then the user should complete inserting information
    profile_id: Annotated[int | None, Field(gt=0)] = None
